...
async function getUserList() {
  ...
  const ret2 = functions.httpsCallable("getUserWithRole");
...
async function CheckForPendingOrganization() {
  ...
  var ret = functions.httpsCallable("getAllOrganizationForOrganizerWithStatus");
...
function GetOrganizationDetails() {
  ...
  const ret1 = functions.httpsCallable("getOrganizationDetails");
...
btnSave.addEventListener('click', e => {
  ...
  if ((organizerID === "" || organizerID === null) ||
    ...
    if (organizationID === "" || organizationID === undefined || organizationID === null) {
      ...
      const ret1 = functions.httpsCallable("addOrganizationDetails");
      ret1(para1).then((result) => {
        //var record1 = result.data;
      ...
      const ret1 = functions.httpsCallable("updateOrganizationDetails");
      ret1(para1).then((result) => {
        //var record1 = result.data;
