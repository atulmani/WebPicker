...
async function CheckForPendingEvent() {
  ...
  var ret = functions.httpsCallable("getAllEventForOrganizerWithStatus");
...
async function populateSportList() {
  ...
  var ret = functions.httpsCallable("getSportList");
...
btnSave2.addEventListener('click', e => {
  ...
  const ret1 = functions.httpsCallable("updateEventDetails_Dates");
  ret1(para1).then((result) => {
    //var record1 = result.data;
    console.log("Event ID: " + result.data.retCode);
    if (result.data.retCode === "0") {
...
btnSave3.addEventListener('click', e => {
  ...
  const ret1 = functions.httpsCallable("updateEventDetails_PaymentStatus");
  ret1(para1).then((result) => {
    //var record1 = result.data;
    console.log("Event ID: " + result.data.retCode);
    if (result.data.retCode === "0") {
...
ClosedEvent.addEventListener('click', e => {
  ...
  const ret1 = functions.httpsCallable("updateEventFlag_CloseEvent");
  ret1(para1).then((result) => {
    //var record1 = result.data;
    console.log("Event ID: " + result.data.retCode);
    if (result.data.retCode === "0") {
...
registrationCompletePostPayment.addEventListener('click', e => {
  ...
  const ret1 = functions.httpsCallable("updateEventFlag_RegistrationCompletePostPayment");
  ret1(para1).then((result) => {
    //var record1 = result.data;
    console.log("Event ID: " + result.data.retCode);
    if (result.data.retCode === "0") {
...
publishMatchSchedule.addEventListener('click', e => {
  ...
  const ret1 = functions.httpsCallable("updateEventFlag_PublishSchedule");
  ret1(para1).then((result) => {
    //var record1 = result.data;
    console.log("Event ID: " + result.data.retCode);
    if (result.data.retCode === "0") {
