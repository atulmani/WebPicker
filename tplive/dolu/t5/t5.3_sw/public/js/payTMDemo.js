...
*/
import { generateSignature } from '/js/PaytmChecksum';

var paytmParams = {};

paytmParams.body = {
    "requestType": "Payment",
    "mid": "Tourna05657364781618",
    "websiteName": "TPLiVE",
    "orderId": "ORDERID_98765",
    "callbackUrl": "https://payTMResponse.html",
    "txnAmount": {
        "value": "1.00",
        "currency": "INR",
    },
...
*/
//generateSignature(JSON.stringify(paytmParams.body), "YOUR_MERCHANT_KEY").then(function (checksum) {
generateSignature(JSON.stringify(paytmParams.body), "3gkJ!L1XwzDE9&Zh").then(function (checksum) {
    ...
    var options = {
        ...
        port: 443,
        path: '/theia/api/v1/initiateTransaction?mid=Tourna05657364781618&orderId=ORDERID_98765',
        method: 'POST',
        headers: {
...
function generateRequest() {
    ...
    //encodedParams.set('key', 'rjQUPktU');
    encodedParams.set('key', 'gtKFFx');
    encodedParams.set('txnid', 'sikU1saRoTdk77');
    ...
    //        encodedParams.set('hash', 'e5iIg1jwi8');
    encodedParams.set('hash', 'eCwWELxi');
    // var hash1 = SHA512(encodedParams);
    var hash = SHA512("gtKFFx | sikU1saRoTdk77 | 10.00 | iPhone | PayU User | test@gmail.com | 9876543210 | https://apiplayground-response.herokuapp.com/ | https://apiplayground-response.herokuapp.com/ |  |  |||||| eCwWELxi");
    //  sha512(key | txnid | amount | productinfo | firstname | email | udf1 | udf2 | udf3 | udf4 | udf5 |||||| SALT)
    // hash = { "v1": "af202c7a2ebf944b9b1e9a0b36187a42b4e611806ae5480f2000fe66db53973cb7e738d95a4e4d3fa275a509dd295920ac4865df2eee254b9f9dfa26acfe65f1", "v2": "54b15f6831d3196a9525cfaf7ee374c69461fc34f65e725a681ff198dfa425b6f8090bb0289b1ac2f378eb08c87611942e8ee07c59282ccd8d66698743b7b20e" }
...
function SHA512(str) {
    ...
    function binb2hex(binarray) {
        var hex_tab = '0123456789abcdef'; var str = ''; var length = binarray.length * 4; var srcByte; for (var i = 0; i < length; i += 1) { srcByte = binarray[i >> 2] >> ((3 - (i % 4)) * 8); str += hex_tab.charAt((srcByte >> 4) & 0xF) + hex_tab.charAt(srcByte & 0xF); }
        return str;
    }
    function safe_add_2(x, y) {
        var lsw, msw, lowOrder, highOrder; lsw = (x.lowOrder & 0xFFFF) + (y.lowOrder & 0xFFFF); msw = (x.lowOrder >>> 16) + (y.lowOrder >>> 16) + (lsw >>> 16); lowOrder = ((msw & 0xFFFF) << 16) | (lsw & 0xFFFF); lsw = (x.highOrder & 0xFFFF) + (y.highOrder & 0xFFFF) + (msw >>> 16); msw = (x.highOrder >>> 16) + (y.highOrder >>> 16) + (lsw >>> 16); highOrder = ((msw & 0xFFFF) << 16) | (lsw & 0xFFFF); return new int64(highOrder, lowOrder);
    }
