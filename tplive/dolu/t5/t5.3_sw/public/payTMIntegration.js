...
const sig_lib = require("./config/PaytmChecksum");
...
function btnPayNow() {
    ...
    var paymentDetails = {
        amount: document.getElementById("hfAmount").value,
        customerId: document.getElementById("hfName").value,
        customerEmail: document.getElementById("hfEmail").value,
        customerPhone: document.getElementById("hfPhone").value
    }
    if (!paymentDetails.amount || !paymentDetails.customerId || !paymentDetails.customerEmail || !paymentDetails.customerPhone) {
        ...
        params['CALLBACK_URL'] = 'http://localhost:3408/callback?custID=' + params['CUST_ID'] + "&orderid=" + params['ORDER_ID'];
