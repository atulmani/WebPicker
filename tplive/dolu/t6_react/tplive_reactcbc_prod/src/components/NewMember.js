...
export default function NewMember(props) {
    ...
    async function regSaveDetails(e) {
        console.log(' in regSaveDetails', user)
        var para = {};
        para = {
            UserID: userDetails.id && userDetails.id !== '0' ? userDetails.id : user.userInfo.uid,
            pID: playerDetailsCopy.pID ? playerDetailsCopy.pID : user.userInfo.uid,
        ...
        <>
            ...
            {!flagLoad && <>
                <div className="row no-gutters">
                    <br></br>
                    {(playerDetailsCopy.PlayerID === userDetails.PlayerID || !props.showBack) && <div className="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <div className="reg-participant-form-field">
                                ...
                                }} value={playerDetailsCopy.Email} />
                                <span>Email</span>
                            </div>

                        </div>

                        {userDetails.UserRole && userDetails.UserRole.map((role) => (
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-12" style={{ padding: '10px' }} key={role.TYPE}>
                                <input type="radio" className="checkbox" style={{ width: '0px' }}
                                    ...
                                    checked={playerDetailsCopy.selectedRole === role.TYPE ? true : false} />
                        ...
                        {!userDetails.UserRole &&
                            ...
                            <div className="col-lg-3 col-md-6 col-sm-12" style={{ padding: '10px' }} key={'PARTICIPANT'}>
                                <input type="radio" className="checkbox" style={{ width: '0px' }}
                                    onChange={(e) => {
                                        e.target.checked && funSelectedRole('PARTICIPANT')
                                    }}
                                    name="userRole" id={"reg" + 'PARTICIPANT'} value={'PARTICIPANT'}
                                    checked={playerDetailsCopy.selectedRole === 'PARTICIPANT' ? true : false} />
                                <label style={{ height: '40px', border: '1px solid #ddd' }}
                ...
                <div className="row no-gutters">
                    ...
                    <div className="col-lg-12 col-md-12 col-sm-12"><br />
                        ...
                        <div className="ref-participant-save-div">
                            {console.log('props.showBack : ', props.showBack)}
                            {props.showBack &&
