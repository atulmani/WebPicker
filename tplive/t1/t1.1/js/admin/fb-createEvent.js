...
document.getElementById("hforganizationid").value = organizationid;

db.collection("Organization").where("OrganizationId", "==", Number(organizationid))
    .get()
    .then((querySnapshot) => {
        querySnapshot.forEach((doc) => {
              console.log(doc.id, " => ", doc.data());
              document.getElementById("eventOrganisationName").value = doc.data().OrganizationName;
              document.getElementById("organisationEmail").value = doc.data().OrganisationEmail;
              document.getElementById("eventorganisationPhone").value = doc.data().OrganisationPhone;
...
function CreateEventData() {
  ...
  db.collection('Events').get().then((snapshot) => {
    ...
    var organizationID = document.getElementById("hforganizationid").value;
