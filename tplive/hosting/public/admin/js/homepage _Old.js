...
function getEventList(filter) {
  ...
  var ret = "";
  //if (filter === "All") {
  // ret = firebase.functions().httpsCallable("getAllEventWithEventStatus1");
  ret = functions.httpsCallable("getAllEventWithEventStatus1");
  console.log('getAllEventWithEventStatus1');
  //}
